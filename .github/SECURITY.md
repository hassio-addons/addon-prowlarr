...
[**Report a vulnerability**](https://github.com/hassio-addons/app-prowlarr/security/advisories/new)
...
- Issues in Prowlarr itself; please report those directly to the
  [Prowlarr project](https://github.com/Prowlarr/Prowlarr/security/policy).
...
This security policy covers the Prowlarr app in this repository: the app
